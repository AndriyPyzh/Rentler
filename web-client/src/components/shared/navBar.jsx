            ...
            <nav className="navbar navbar-expand-xl navbar-light bg-light border-bottom sticky-top">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className="navbar-nav d-flex align-items-center border-left" style={ { width: '540px' } }>
                        <NavLink className="btn btn-outline-warning ml-4 mr-2 list-property-button"
                                 to="/add-apartment">List a Property</NavLink>
                        <NavLink className="nav-item nav-link m-1 mx-2" to="/login">Log In</NavLink>
                        <NavLink className="nav-item nav-link m-1 mx-2" to="/signup">Sign Up</NavLink>
                    </div>
                </div>
            </nav>
        );
